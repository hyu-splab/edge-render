...
void glVertexAttribPointer(GLuint index, GLint size, GLuint type, GLboolean normalized, GLsizei stride, const void *pointer);
#endif
...
void glGetDebugMessageLogARB(GLuint count, GLsizei bufSize, GLenum *sources, GLenum *types, GLuint *ids, GLenum *severities, GLsizei *lengths, GLchar *messageLog);
...
void glDeleteFramebuffersEXT(GLsizei n, const GLuint *framebuffer);
